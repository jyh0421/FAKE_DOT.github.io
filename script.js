...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const folderMappings = {
        folder1: ["popup1", "popup2", "popup3", "popup4", "popup5"], // 연예 폴더
        folder2: ["popup-politics1", "popup-politics2","popup-politics3"], // 정치 폴더
        folder3: ["popup-social1", "popup-social2"], // 사회 폴더
        folder4: ["popup-lifestyle1", "popup-lifestyle2"], // 생활/문화 폴더
    };
